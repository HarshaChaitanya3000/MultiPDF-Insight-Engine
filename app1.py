...
try:
    ...
    st.write("Credentials loaded successfully!")  # Remove in production
...
def get_vector_store(text_chunks):
    ...
    vector_store.save_local("faiss_index")  # Consider persistent storage for production
...
def user_input(user_question):
    ...
    if os.path.exists("faiss_index"):  # Consider persistent storage for production
